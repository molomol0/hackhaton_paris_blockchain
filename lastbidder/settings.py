"""
Django settings for lastbidder project.
...
SECRET_KEY = 'django-insecure-#xk2fj6g!on-3e3%##0mq+u4z_+ux82!7kgwia@yl$blz)dqsx'
...
WSGI_APPLICATION = 'lastbidder.wsgi.application'
